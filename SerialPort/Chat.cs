...
namespace SerialPort
{
    public partial class Chat : Form
    {
        ...
        public void SerialPort_DataReceived(object sender, SerialDataReceivedEventArgs args) => richTextBox1.AppendText(
            DateTime.Now.ToString("T") + ": " + Encoding.UTF8.GetString(SPort.ReadBytes()) + "\n");

        private void Chat_FormClosed(object sender, FormClosedEventArgs e) => Application.Exit();

        private void Chat_Shown(object sender, EventArgs e) => textBox1.Focus();
        ...
        private void SendButton_Click(object sender, EventArgs e)
        {
            ...
            {
                richTextBox1.AppendText("LOST (" + SPort.PortName + ") " + DateTime.Now.ToString("T") + ": " + SPort.LostBytes + "\n");
        ...
        private void Chat_Load(object sender, EventArgs e) => Text = SPort.PortName;
